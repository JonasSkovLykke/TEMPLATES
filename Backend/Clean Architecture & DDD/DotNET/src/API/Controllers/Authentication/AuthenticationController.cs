...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder AuthenticationController<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
        ...
        //    confirmEmailEndpointName = $"{nameof(AuthenticationController)}-{finalPattern}";
