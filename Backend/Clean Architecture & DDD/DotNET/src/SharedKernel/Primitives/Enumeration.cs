...
{
    // Lazily initialize a dictionary to store enumeration values by their IDs
    ...
    // Equality operators for comparing enumeration instances
    ...
    public static bool operator !=(Enumeration<TEnum>? a, Enumeration<TEnum>? b)
    {
        ...
        if (a is null || b is null)
        {
            return true; // Return true if either one is null, indicating inequality
        }
    ...
    /// <summary>
    /// Creates an enumeration of the specified type based on the specified nullable identifier.
    /// </summary>
    /// <param name="id">The nullable enumeration identifier.</param>
    /// <returns>The enumeration instance that matches the specified identifier, if it exists.</returns>
    public static TEnum? FromNullableId(int? id)
    {
        if (id.HasValue)
        {
            return FromId(id.Value);
        }
    ...
    // Create a dictionary of enumeration values based on their IDs
    ...
    // Retrieve fields of the specified type and convert them to enumeration instances
